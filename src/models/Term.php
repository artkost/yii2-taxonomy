...
use artkost\yii2\taxonomy\TermInterface;
use Yii;
 ...
 */
class Term extends ActiveRecord implements TermInterface
{
    /**
     * @var int
     */
    ...
    public function validateHasParent($attribute, $params)
    {
        if (!$this->hasErrors() && $this->getParent() == null) {
            $this->addError($attribute, Manager::t('model', 'Invalid parent term id'));
        }
    }
