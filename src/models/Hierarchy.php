 ...
 */
class Hierarchy extends ActiveRecord implements HierarchyInterface
{
    ...
    {
        return [
            'vid' => Manager::t('model', 'Vocabulary ID'),
            'parent_id' => Manager::t('model', 'Parent ID'),
            'child_id' => Manager::t('model', 'Child ID'),
        ];
    }
